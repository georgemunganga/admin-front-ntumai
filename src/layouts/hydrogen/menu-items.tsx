...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    dropdownItems: [
      ...
      { name: "Drivers", href: routes.fleet.drivers },
      { name: "Driver Applications", href: routes.fleet.driverApplications },
      { name: "Driver Documents", href: routes.fleet.driverDocuments },
      { name: "Driver Incentives", href: routes.fleet.driverIncentives },
      { name: "Driver Payouts", href: routes.fleet.driverPayouts },
  ...
  { name: "Growth" },
  {
    ...
    dropdownItems: [
      ...
      { name: "Driver Incentives", href: routes.growth.campaigns },
