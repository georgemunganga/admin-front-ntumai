      ...
      <div className="grid gap-6 xl:grid-cols-[1.5fr_1fr]">
        <ShellCard title="Shipment information" description="Core shipment fields.">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Input label="Tasker" rounded="lg" />
            <Input label="Pickup" rounded="lg" />
            <Input label="Dropoff" rounded="lg" />
            <Input label="Lane" rounded="lg" />
            <Input label="Value" rounded="lg" />
          </div>
          <div className="mt-4">
        ...
        <ShellCard title="Status" description="Initial shipment state.">
          <div className="space-y-4">
            <Select label="Shipment status" options={statusOptions} selectClassName="rounded-2xl" />
