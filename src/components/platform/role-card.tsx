...
import { ActionIcon, Button, Dropdown, Title } from "rizzui";
    ...
    <div className={cn("rounded-lg border border-muted p-6", className)}>
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
              ...
              <path d="M15.59 18.9736C14.9612 19.3001 13.3126 19.9668 14.3167 20.801C14.8072 21.2085 15.3536 21.4999 16.0404 21.4999H19.9596C20.6464 21.4999 21.1928 21.2085 21.6833 20.801C22.6874 19.9668 21.0388 19.3001 20.41 18.9736C18.9355 18.208 17.0645 18.208 15.59 18.9736Z" stroke="currentColor" strokeWidth="1.3" />
              <path d="M20 14.4378C20 15.508 19.1046 16.3756 18 16.3756C16.8954 16.3756 16 15.508 16 14.4378C16 13.3676 16.8954 12.5 18 12.5C19.1046 12.5 20 13.3676 20 14.4378Z" stroke="currentColor" strokeWidth="1.3" />
            </svg>
          </span>
      ...
      <div className="mt-4 flex items-center gap-2">
        <div className="flex items-center">
          {users.slice(0, 4).map((avatar, index) => (
            <figure key={`${avatar}-${index}`} className="relative z-10 -ml-1.5 h-8 w-8 rounded-full border-2 border-white">
              <Image src={avatar} alt="user avatar" fill className="rounded-full object-cover" sizes="32px" />
            </figure>
          ))}
        </div>
